...
print("konversi suhu",75, "derajat celcius adalah ",fahrenheit, "derajat fahrenheit") # Output: 167.0

# Konversi suhu 60 derajat Celsius ke Reamur
reamur = KonversiSuhu.celsius_ke_reamur(60)
print("konversi suhu",60, "derajat celcius adalah ",reamur, "derajat reamur") # Output: 48.0

# Konversi suhu 90 derajat Celsius ke Kelvin
kelvin = KonversiSuhu.celsius_ke_kelvin(90)
print("konversi suhu",90, "derajat celcius adalah ",kelvin, "derajat kelvin") # Output: 363.15